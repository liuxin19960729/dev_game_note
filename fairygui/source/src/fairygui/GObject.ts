...
namespace fgui {
    ...
    export class GObject {
        ...
        protected _node: cc.Node;//每个Gbject里面的cc.Node节点
        ...
        public static _defaultGroupIndex: number = -1//分组

        public constructor() {
            this._node = new cc.Node();
            if (GObject._defaultGroupIndex == -1) {
                GObject._defaultGroupIndex = 0;//cocos (default 分组)
                //groupList  获取的分组就是cocos 节点的分组信息 (碰撞  摄像机显示 .... )
            ...
            this._node["$gobj"] = this;//cc.Node  扩展属性当前 fgui ui类
            this._node.groupIndex = GObject._defaultGroupIndex;
            this._node.setAnchorPoint(0, 1);//锚点 左上   ==轴心 和 锚点是两个 体系  可以设为一个  _pivotAsAnchor=true
        ...
        public handlePositionChanged(): void {
            ...
            this._node.setPosition(xv, yv);// 默认的锚点是 (0,1) 左上角
        }
