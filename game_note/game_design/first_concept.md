...
```
原文:
This chapter focuses on how to assemble the basic game-
play treatment, which is really just a document of no
...
asssmbly n 汇编 集合 汇合
real adj 实际的 真实的
really adv 实际地 真实地 事实上
翻译:这章集中去汇集这些基础的玩法处理,这实际上就是不超过4,6页的文档。


It is a proto-manifesto to
communicate your concept for the game, and, most of all,
your feeling of what the game would be like to play.

单词:
proto n 原型 样机
manifesto n 宣告  声明 告示
          v 发表宣言
communicate v 通讯 传达 交流 感染          
翻译:文档是传达你游戏概念的原型通告。
...
单词:
eventual adj 最终的 有条件的
eventually adv 最终 终于
specification n 规范 规格 说明书
solidify v 凝固 凝结 巩固
thought n 思考 考虑 想法 关心
grow v 生长 发展
翻译:最终,处理将会发展成对游戏的完整规范,但书写初始化处理将帮助你巩固想法。


You can return to the treatment later,
whenever you feel in danger of getting lost in the details of
the design, to get back on track with your original idea.
...
whenever 无论 合适 无论怎样
get lost 迷路           
翻译:你能恢复你之前的处理想法,无论何时你感觉在细节设计感到危险，你可以回退去追踪你的目标想法。
...
publish v 出版  发表 公布 刊印
翻译:甚至好于之前,处理 是 一些事你可以使用去推销有到其他的发行人 程序员 或美术人员 去开发者游戏。
...
exmine v 检查 调查
sample n 样品 样本
翻译:首先,你讲学会去寻找,形成和提炼你的理论。我们将看样本的游戏样式处理和检查。
